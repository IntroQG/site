...
.. figure:: img/errors-known.png
    :width: 500 px
    :align: center
    :alt: Errors with a known value

    Figure 3. Random any systematic errors when the true value is known.
    Source: Figure 4.1 from `Taylor, 1997 <http://www.uscibooks.com/taylornb.htm>`__.
...
.. figure:: img/errors-unknown.png
    :width: 500 px
    :align: center
    :alt: Errors with an unknown value
