...
.. admonition:: Start your assignment
    ...
    You can start working on your copy of Exercise 3 by `accepting the GitHub Classroom assignment <https://classroom.github.com/a/Ek6Sje6m>`__.

    **Exercise 3 is due by 12:15 on November 19th 2025**.

You can also take a look at the open course copy of `Exercise 3 in the course GitHub repository <https://github.com/introqg-2025/Exercise-3>`__ (does not require logging in).
